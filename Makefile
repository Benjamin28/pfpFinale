...
TEST_OBJS_PARALLEL_LOOP2_OPT_12x4   := driver.o Gemm_Parallel_Loop2_Opt_12x4.o 

driver_Gemm_Parallel_Loop2_Opt_12x4.x: $(TEST_OBJS_PARALLEL_LOOP2_OPT_12x4) $(UTIL_OBJS)
	$(LINKER) $(TEST_OBJS_PARALLEL_LOOP2_OPT_12x4) $(UTIL_OBJS) $(BLAS_LIB) -o driver_Gemm_Parallel_Loop2_Opt_12x4.x $(LDFLAGS) 

test_Gemm_Parallel_Loop2_Opt_12x4: driver_Gemm_Parallel_Loop2_Opt_12x4.x
	echo "your_version = 'Parallel Loop 2 Opt';" > output_data_Gemm_Parallel_Loop2_Opt_12x4.m
	echo "$(NREPEATS) $(NFIRST) $(NLAST) $(NINC)" | ./driver_Gemm_Parallel_Loop2_Opt_12x4.x >> output_data_Gemm_Parallel_Loop2_Opt_12x4.m
...
TEST_OBJS_PARALLEL_LOOP3_OPT_12x4   := driver.o Gemm_Parallel_Loop3_Opt_12x4.o 

driver_Gemm_Parallel_Loop3_Opt_12x4.x: $(TEST_OBJS_PARALLEL_LOOP3_OPT_12x4) $(UTIL_OBJS)
	$(LINKER) $(TEST_OBJS_PARALLEL_LOOP3_OPT_12x4) $(UTIL_OBJS) $(BLAS_LIB) -o driver_Gemm_Parallel_Loop3_Opt_12x4.x $(LDFLAGS) 

test_Gemm_Parallel_Loop3_Opt_12x4: driver_Gemm_Parallel_Loop3_Opt_12x4.x
	echo "your_version = 'Parallel Loop 3 Opt';" > output_data_Gemm_Parallel_Loop3_Opt_12x4.m
	echo "$(NREPEATS) $(NFIRST) $(NLAST) $(NINC)" | ./driver_Gemm_Parallel_Loop3_Opt_12x4.x >> output_data_Gemm_Parallel_Loop3_Opt_12x4.m
